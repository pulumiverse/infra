...
export function CheckoutRepoOnPathStep(path: string, repo: string): Step {
  return {
...
export function CheckoutScriptsRepoStep(): Step {
  return CheckoutRepoOnPathStep("ci-scripts", "pulumi/scripts");
}
...
export function PullRequest(
  ...
  return {
    ...
    with: {
      author: "Pulumiverse Bot <bot@pulumiverse.com>",
      body: "This PR was automatically generated by the run-regenerate-workflows workflow in this repo.",
      branch: "update-github-actions-workflows-${{ github.run_number }}",
      committer: "Pulumiverse Bot <bot@pulumiverse.com>",
      "commit-message": "[internal] Update GitHub Actions workflow files",
      labels: "impact/no-changelog-required",
      title: "Update GitHub Actions workflows.",
      path: `pulumi-${provider}`,
...
export function RegenerateWorkflows(provider: string): Step {
  return {
    name: "Regenerate the workflows for this provider",
    run: 
    "cd infra/ci-mgmt\n" + 
    "npm ci\n" +
    `npm run gen -- --name ${provider} --path ../.. --debug`,
  }
}
